...
@section('content')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 style="text-align: center; color: #004A7F !important;" class="m-0 font-weight-bold text-primary">Eliminar padrino/madrina</h6>
            </div>
            <div class="card-body">
                  ...
                  <div class="social-line">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="name" type="text" class="form-control" placeholder="Nombre del padrino/madrina..." value="{{ $godparent->name }}" disabled>
                            @if ($errors->has('name'))
