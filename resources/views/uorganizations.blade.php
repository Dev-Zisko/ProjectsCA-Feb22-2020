...
@section('content')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 style="text-align: center; color: #004A7F !important;" class="m-0 font-weight-bold text-primary">Editar organización</h6>
            </div>
            <div class="card-body">
                  ...
                  <div class="social-line">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="name" name="name" type="text" class="form-control" placeholder="Nombre de la organización.." value="{{ $organization->name }}" required>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group{{ $errors->has('person_contact') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="person_contact" name="person_contact" type="text" class="form-control" placeholder="Persona de contacto..." value="{{ $organization->person_contact }}" required>
                    ...
                    <div class="form-group{{ $errors->has('person_position') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="person_position" name="person_position" type="text" class="form-control" placeholder="Posición..." value="{{ $organization->person_position }}" required>
                    ...
                    <div class="form-group{{ $errors->has('person_mail') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <textarea id="person_mail" type="text" class="form-control" name="person_mail" placeholder="Escriba aquí..." value="{{ old('person_mail') }}" required rows="4" cols="50">{{ $organization->person_mail }}</textarea>
                    ...
                    <div class="form-group{{ $errors->has('person_cellphone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <textarea id="person_cellphone" type="text" class="form-control" name="person_cellphone" placeholder="Escriba aquí..." value="{{ old('person_cellphone') }}" required rows="4" cols="50">{{ $organization->person_cellphone }}</textarea>
